...
int main(int argc,char *argv[])
{
    ...
    OnOffHelper onoffhelper1 ("ns3::TcpSocketFactory",Address(InetSocketAddress(Ipv4Address("10.1.1.1"),10)));
    ...
    onoffhelper1.SetAttribute("DataRate",StringValue("2Mbps"));
    onoffhelper1.SetAttribute("PacketSize",UintegerValue(1024));

   /* OnOffHelper onoffhelper2 ("ns3::TcpSocketFactory",Address(InetSocketAddress(Ipv4Address("10.1.1.1"),10)));
    ...
    onoffhelper2.SetAttribute("DataRate",StringValue("2Mbps"));
    ...
    app=onoffhelper1.Install(nodes.Get(2));
    app=onoffhelper.Install(nodes.Get(1));
    ...
    anim2.UpdateNodeSize(0,0.1,0.1);
    anim2.UpdateNodeSize(1,0.1,0.1);
    anim2.UpdateNodeSize(2,0.1,0.1);
    anim2.UpdateNodeSize(3,0.1,0.1);
